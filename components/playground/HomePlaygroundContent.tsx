...
import { PlaygroundHomeQuickActionCards } from "@/components/playground/PlaygroundHomeQuickActionCards"

export function HomePlaygroundContent() {
  ...
  return (
    <div className="home-playground-page flex min-h-screen flex-col items-center justify-center px-8 py-16">
      <div className="home-playground-container flex w-full max-w-[680px] flex-col">
        ...
        <PlaygroundHomeQuickActionCards className="mt-9" />
      </div>
    </div>
  )
}
